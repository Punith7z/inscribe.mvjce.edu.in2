          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {events.map((event) => (
              <div
                ...
                className="bg-white/40 dark:bg-transparent rounded-3xl shadow-lg border border-black/5 dark:border-white/10 overflow-hidden transition-all duration-200 cursor-pointer hover:shadow-2xl hover:scale-105 hover:shadow-accent-2/20 backdrop-blur-sm"
              >
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-800 dark:text-gray-200 text-base">{event.description}</p>
                </div>
              </div>
            ))}
          </div>
