  ...
  return (
    <div className="min-h-screen bg-gradient-bg">
      ...
      {modalOpen && selectedDomainConfig && (
        ...
        >
          <div
            className="bg-gradient-bg rounded-3xl max-w-6xl w-full shadow-2xl relative my-8 animate-slideIn"
          ...
          >
            ...
            <button
              onClick={closeModal}
              className="absolute top-4 right-4 z-50 w-12 h-12 rounded-full bg-white/90 hover:bg-white shadow-lg flex items-center justify-center text-accent-2 hover:text-heading transition-all hover:scale-110 hover:rotate-90"
            >
...
const MemberCard = ({ member }) => {
  return (
    <div className="card-gradient rounded-3xl overflow-hidden border border-black/5 flex flex-col min-w-[220px] max-w-[220px] transition-all duration-300 hover:shadow-xl hover:shadow-accent-2/15 hover:-translate-y-1">
      {/* Profile Image */}
