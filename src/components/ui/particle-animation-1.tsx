...
const ParticleAnimation = ({
  gridSize = 500,
  containerSize = '100vmin', // Updated default based on user Demo
  particleCount = 500,
  ...
  useEffect(() => {
    // Generate new particles and recalculate if props change
  ...
  // ^^^ We add 'colors' here so changing theme will trigger random re-assignment of colors
  ...
  return (
    ...
    >
      ...
      {/* Replaced styled-jsx with normal style block for Vite */}
      <style>{`
        ${particles.map(particle => `
