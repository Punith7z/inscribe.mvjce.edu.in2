...
function ShaderCanvas({
  ...
  useEffect(() => {
    ...
    function applySize() {
      ...
      if (disposed) return;
      const dpr = getDpr();
      // Use window dimensions to ensure full coverage regardless of scrollbars
...
/* ========= Exported component: fixed fullscreen background ========= */
export function NavyGridBackground() {
  return (
    <div
      style={{
        position: "fixed",
        ...
        background: "#030912",
        overflow: "hidden",
        zIndex: 0,          /* sits above global Background3D (-1) */
        pointerEvents: "none",
      }}
    >
...
export default NavyGridBackground;
