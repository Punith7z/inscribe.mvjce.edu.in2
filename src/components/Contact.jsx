  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="max-w-4xl mx-auto card-gradient rounded-3xl p-10 text-center transition-all duration-300 hover:shadow-lg hover:shadow-accent-2/15 border border-black/5 group overflow-hidden relative">
